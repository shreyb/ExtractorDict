...
class expMetaData(MetaData):
    ...
    def __init__(self, expname, inputfile):
        ...
        try:
            expmodule = __import__(self.exp_md_keyfile)
        except ImportError:
            print "You have not defined an experiment-specific metadata and key-translating module in {}.  Exiting". \
                format(self.exp_md_keyfile)
            raise
        self.metadataList, self.translateKeyf = expmodule.metadataList(expname), expmodule.translateKey
